...
type RestError struct {
	...
	Causes     []byte `protobuf:"bytes,4,opt,name=causes,proto3" json:"causes,omitempty"`
}
...
func (x *RestError) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *RestError) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *RestError) GetCauses() []byte {
	if x != nil {
		return x.Causes
	}
	return nil
...
var file_error_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x74, 0x0a, 0x09, 0x52, 0x65, 0x73,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x61, 0x75, 0x73, 0x65,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x63, 0x61, 0x75, 0x73, 0x65, 0x73, 0x42,
	0x18, 0x5a, 0x16, 0x72, 0x65, 0x73, 0x74, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2f, 0x69, 0x6e,
...
var file_error_proto_goTypes = []any{
	(*RestError)(nil), // 0: resterrors.RestError
}
